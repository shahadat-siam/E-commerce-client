    ...
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <h2 className="text-2xl  font-semibold font-sant mb-3">Please Signup! </h2>
            </div>
          <form onSubmit={handleSubmit(onSubmit)}>

            <div className="mb-3">
              <label className="block text-start text-gray-700 text-sm font-bold mb-2" htmlFor="name">
                Name
              </label>
              <input
            ...
            <div className="mb-3">
              <label className="block text-start text-gray-700 text-sm font-bold mb-2" htmlFor="email">
                Email
              </label>
              <input
                className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
            ...
            <div className="mb-4 relative">
              <label className="block text-start text-gray-700 text-sm font-bold mb-2" htmlFor="password">
                Password
              </label>
              <input
          ...
          <p className="text-start text-sm mt-4">Already have an account? Please <Link to='/login' className="cursor-pointer hover:underline text-[#E90074]">Login</Link></p>
        </div>
      </div>
    </div>
  );
